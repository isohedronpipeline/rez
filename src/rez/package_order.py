...
class CustomPackageOrder(PackageOrder):
    ...
    def __init__(self, packages: Dict[str, List[Union[str, VersionRange]]]):
        """Create a reorderer.
        Args:
...
class PyPAPackageOrder(PackageOrder):
    ...
    @staticmethod
    def pypa_cmpkey(version: Version, prerelease: Literal["", "rc", "b", "a"] = ""):
        """
    ...
    def sort_key_implementation(self, package_name, version):
        return self.pypa_cmpkey(version, self.prerelease)
